    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" name="universitas" class="form-control" placeholder="Masukan Nama Instansi" required>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="input-group my-3">
                    ...
                    <div class="input-group-append">
                        <button type="button" id="pilih_foto" class="browse btn btn-info"><i class="fa fa-search"></i>
                            Pilih</button>
                    </div>
                </div>

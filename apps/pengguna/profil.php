            ...
            <div class="panel-body">
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td>Foto</td>
                            <td width="20%">: <img src="apps/mahasiswa/foto/<?php echo $data['foto']; ?>" id="preview"
                                    width="25%" class="rounded" alt="Cinque Terre"></td>
                        </tr>
                    </tbody>
                </table>
                <div class="form-group">
                    <button kode_mahasiswa="<?php echo $data['kode_mahasiswa']; ?>"
                        class="password btn btn-info btn-circle"><i class="fa fa-key"></i>Password</button>
                </div>
            </div>
        </div>
    </div>
